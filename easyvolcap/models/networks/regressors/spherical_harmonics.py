...
class SphericalHarmonics(nn.Module):
    def __init__(self,
                 ...
                 mlp_regressor_cfg: dotdict = dotdict(type=MlpRegressor.__name__, backend='torch'),  # the humble sh parameter recovery system
                 **kwargs,
                 ) -> None:
        super().__init__()
        self.sh_deg = sh_deg
    ...
    def execute(self, feat: jt.Var, batch: dotdict = None, return_sh: bool = False):
