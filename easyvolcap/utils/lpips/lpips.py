...
jt.flags.use_cuda=1
import easyvolcap.utils.lpips.pretrained_networks as pn
        ...
        if(lpips):
            ...
            if(pretrained):
                ...
                if(model_path is None):
                    #print("jijiooo")
                    model_path = '/data2/zhouzz/4K4D-jittor-test/easyvolcap/utils/lpips/weights/jt_lpips_%s_v01.pkl'%net
                #if(verbose):
